...
xgb_classifier = XGBClassifier(n_estimators=300, max_depth=10, learning_rate=0.05, random_state=42)
# Train the model
...
def medical_predict():
    if request.method == 'POST':
        ...
        # Make prediction
        prediction = xgb_classifier.predict(np.array([[age, sex, cp, trestbps, chol, fbs, restecg, thalach,
                                                      exang, oldpeak, slope]]))
